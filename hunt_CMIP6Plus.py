...
path_l = '/g100_work/IscrC_SPREM3-5/vlembo00/optimesm-tipping/maxj99_std99_30p99_oetd99_oett99/figures_{}_cnrm_TIPMIP'.format(today)
    ...
    if os.path.isdir(grp_dir) and os.listdir(grp_dir):
        ...
        for vee in vers:
            ...
            if grp=='mohc':
                ...
                cmip_dir = os.path.join(path, 'smhi/CMIP6/CMIP')
            elif grp == 'cnrm':
